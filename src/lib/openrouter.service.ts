import type { ChatMessage, CompletionOptions, JsonSchema, OpenRouterConfig, OpenRouterResponse } from './openrouter.types';
import { OpenRouterError, AuthenticationError, RateLimitError, InvalidRequestError, ServerError } from './openrouter.errors';
...
export class OpenRouterService {
  ...
  private async handleError(response: Response): Promise<never> {
    ...
    switch (response.status) {
      ...
      case 400: throw new InvalidRequestError(message);
      default: 
