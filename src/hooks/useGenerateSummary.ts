...
export function useGenerateSummary() {
  ...
  const validationStatus = useMemo((): ValidationStatusViewModel => {
    ...
    return status;
  }, [debouncedUrl, isPreviewLoading, isVideoMetaError, videoMetaError, videoMeta, isGenerationStatusFetching, isGenerationStatusError, generationStatus, generationStatusError]);
